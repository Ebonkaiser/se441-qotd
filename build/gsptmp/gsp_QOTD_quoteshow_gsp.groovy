...
invokeTag('enabled','feature',32,['feature':("ShowAttributions")],2)
printHtmlPart(15)
createTagBody(2, {->
printHtmlPart(16)
createTagBody(3, {->
...
invokeTag('link','g',36,['class':("edit"),'action':("edit"),'resource':(this.quote)],3)
printHtmlPart(17)
...
invokeTag('form','g',39,['resource':(this.quote),'method':("DELETE")],2)
printHtmlPart(20)
})
...
public static final long LAST_MODIFIED = 1462222679966L
